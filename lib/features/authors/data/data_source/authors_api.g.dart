...
class _AuthorsApi implements AuthorsApi {
  _AuthorsApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<AuthorsDataDto> getAuthors({required String keyword}) async {
    ...
    late AuthorsDataDto _value;
    try {
      _value = AuthorsDataDto.fromJson(_result.data!);
    } on Object catch (e, s) {
